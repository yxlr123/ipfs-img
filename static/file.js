$(() => {
  ...
  $(document).on("paste", (event) => {
    ...
    if (!clipboardData || !clipboardData.items)
      ...
      return alert("褰撳墠娴忚鍣ㄤ笉鏀寔绮樿创涓婁紶");

    let items = clipboardData.items;

    let file = null;

    if (items.length === 0) return alert("鍓垏鏉垮唴鏃犲唴瀹规垨涓嶆敮鎸佹闈㈡枃浠�");
    ...
    if (!file) return alert("鍓垏鏉垮唴鏃犲唴瀹规垨涓嶆敮鎸佹闈㈡枃浠�");
  ...
  function upload(files) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (
        ...
        parent.alert("鏂囦欢绫诲瀷閿欒,璇蜂笂浼犲浘鐗囩被鍨�");
        ...
        parent.alert("涓婁紶鐨勬枃浠朵笉鑳借秴杩�" + maxSize / 102400000000 / 10240000000000 + "MB");
                ...
                <div class="item ${randomClass}">
                    ...
                    <div class="file">
                        ...
                        <div class="desc">
                            ...
                            <div class="desc__size">SIZE:${formatBytes(
						...
						<a title="鍒犻櫎" class="link" onclick="del(this);return false;">                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50.13 50.13" style="enable-background:new 0 0 50.13 50.13;" xml:space="preserve">
        ...
        $.ajax({
          ...
          headers: {
            ...
            Authorization:
              ...
              "Basic MkRFeXJkTnBScmFoRUEwRk13VW1lTFJ5QUJUOjVhYzA1Zjg0Y2FmMzhiNWIwZWZjNjA5Zjc0NGMxNDFm"
            ...
            if (res.code === -1) {
              ...
              if (res.Hash) {
                ...
                $("." + randomClass)
                  ...
                  .attr({ href: imgSrc, target: "_blank" });
                ...
                $("." + randomClass)
                  ...
                  .attr({ value: '<img src="' + imgSrc + '"/>' });

                $("." + randomClass)

                  .find("#Imgs_Ubb")

                  .attr({ value: "[img]" + imgSrc + "[/img]" });
...
function chage(obj) {
  ...
  for (var i = 0; i < document.querySelectorAll("#show").length; i++) {
    ...
    var newurl = document
      ...
      [i].value.replace(/https:\/\/([^\/]+)/i, "https://" + obj.value);
...
function copyAll(obj) {
  ...
  if (browserRedirect()) {
    ...
    alert(
      ...
      "璁惧绫诲瀷涓烘墜鏈猴紝鏈変竴瀹氬嚑鐜囧鍒跺け璐ワ紒璇锋煡鐪嬪壀鍒囨澘鏄惁鎴愬姛澶嶅埗"
...
function display(id) {
  ...
  var odt = document.getElementById(id);

  if (odt.style.display == "none") {
